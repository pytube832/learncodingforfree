...
<script>if(document.documentElement.lang ="ja"){document.getElementById("p").innerHTML = document.documentElement.lang = "ja";}else{alert("hello world")}</script>
